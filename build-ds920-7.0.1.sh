...
git clone --depth=1 https://github.com/cuckoohello/redpill-load.git
...
# build redpill-lkm
cd redpill-lkm
make LINUX_SRC=../geminilake/usr/local/x86_64-pc-linux-gnu/x86_64-pc-linux-gnu/sys-root/usr/lib/modules/DSM-7.0/build test-v7
...
# build redpill-load
cd redpill-load
cp ${root}/user_config.DS920+.json ./user_config.json
sudo ./build-loader.sh 'DS920+' '7.0.1-42218'
mv images/redpill-DS920+_7.0.1-42218*.img ${root}/output/
cd ${root}
